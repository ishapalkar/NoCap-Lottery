    ...
    <div style={styles.container}>
      <div style={styles.content}>
        ...
        <motion.div style={styles.titleSection} initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.3, delay: 0.1 }}>
          ...
          <h1 style={styles.title}>Solana Speedrun</h1>
        ...
        <div style={styles.mainGrid}>
          <motion.div style={styles.prizeCard} className="card-squishy" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.3, delay: 0.2 }}>
            <div style={styles.prizeHeader}>
              ...
              <div style={styles.prizeAmount}>$15,000</div>
            </div>
              ...
              <div style={styles.detailRow}>
                <div style={styles.detailItem}>
                  ...
                  <div>
                    ...
                    <div style={styles.detailValue}>1d 18h 30m</div>
                  </div>
                </div>
                <div style={styles.detailItem}>
                  ...
                  <div>
                    ...
                    <div style={styles.detailValue}>1 in 600</div>
                  </div>
                </div>
              </div>
            ...
            <div style={styles.progressSection}>
              <div style={styles.progressHeader}>
                ...
                <span style={styles.progressAmount}>$850,000 deposited</span>
              </div>
              <div style={styles.progressBarContainer}>
                <motion.div style={styles.progressBarFill} initial={{ width: 0 }} animate={{ width: '68%' }} transition={{ duration: 1, delay: 0.5 }} />
              </div>
            </div>
          </motion.div>

          <motion.div style={styles.depositCard} initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.3, delay: 0.3 }}>
            <h2 style={styles.depositTitle}>SOL DEPOSITS</h2>
            ...
            <div style={styles.comingSoonBox}>
              ...
              <p style={styles.comingSoonText}>Solana pool smart contracts deploying soon. UI is ready!</p>
            </div>
          </motion.div>
        </div>
        ...
        <DepositOptionsModal
          ...
          poolName="Solana Speedrun"
          targetChainId={11155111}
          supportedAssets={['SOL']}
          onDirectDeposit={() => {
            alert('🚀 SOL Pool Coming Soon!\n\nDirect SOL deposit will be available once smart contracts are deployed.');
            setShowOptionsModal(false);
          }}
          onYellowDeposit={() => {
            alert('⚡ Yellow Network for SOL Coming Soon!\n\nInstant, gas-free SOL deposits will be available soon.');
            setShowOptionsModal(false);
          }}
          onBridgeDeposit={() => {
            alert('🌉 LI.FI Bridge for SOL Coming Soon!\n\nCross-chain SOL deposits will be available soon.');
            setShowOptionsModal(false);
          }}
        />
          ...
          {activeTab === 'RULES' && (
            <motion.div style={styles.tabContent} initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.2 }}>
              <ol style={styles.rulesList}>
                <li style={styles.ruleItem}><strong>Deposit SOL into the pool to get tickets.</strong></li>
                <li style={styles.ruleItem}><strong>1 SOL = 100 Tickets. More tickets = higher chance to win.</strong></li>
              </ol>
            </motion.div>
          )}
          {activeTab === 'WINNERS' && (
...
const styles = {
  ...
  progressBarFill: { height: '100%', background: '#06d6a0' },
