...
export function Pools() {
  ...
  const pools = [
    {
      id: 'stablecoins',
      name: 'Stablecoins Pool',
      status: 'active',
      minDeposit: '$100 USDC',
      drawFrequency: 'Weekly',
      chain: 'Multi-Chain',
      chainId: 11155111,
      description: 'Deposit USDC/USDT/DAI and earn yield through Aave V3. Weekly draws with Chainlink VRF.',
      color: '#06d6a0',
      borderColor: '#06d6a0',
    },
    {
      ...
      chain: 'Multi-Chain',
      chainId: 11155111,
      description: 'Deposit WETH and earn yield. Weekly prize draws powered by Chainlink VRF.',
      color: '#627eea',
      borderColor: '#627eea',
    },
    {
      ...
      chain: 'Multi-Chain',
      chainId: 11155111,
      description: 'Wrapped Bitcoin deposits with yield generation. Coming soon!',
      color: '#f7931a',
      borderColor: '#f7931a',
    },
  ];
